...
class ReservationContentTablet extends StatefulWidget {
  const ReservationContentTablet({super.key});

  @override
  State<ReservationContentTablet> createState() => _ReservationContentTabletState();
}

class _ReservationContentTabletState extends State<ReservationContentTablet> {
