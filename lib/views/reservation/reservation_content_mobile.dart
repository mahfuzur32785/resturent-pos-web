...
class ReservationContentMobile extends StatefulWidget {
  const ReservationContentMobile({super.key});

  @override
  State<ReservationContentMobile> createState() => _ReservationContentMobileState();
}

class _ReservationContentMobileState extends State<ReservationContentMobile> {
